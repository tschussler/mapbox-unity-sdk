...
namespace Drawers
{
    ...
    public class TypeAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label)
        {
            ...
            var att = attribute as TypeAttribute;
            ...
            for (int i = 0; i < list.arraySize; i++)
            {
                ...
                GUI.enabled = false;
                list.GetArrayElementAtIndex(i).objectReferenceValue = EditorGUI.ObjectField(nameRect, new GUIContent("Script"), list.GetArrayElementAtIndex(i).objectReferenceValue, att.Type, false) as ScriptableObject;
                GUI.enabled = true;
                ...
                {
                    Mapbox.Editor.ScriptableCreatorWindow.Open(att.Type, list, i);
                }
            ...
            {
                Mapbox.Editor.ScriptableCreatorWindow.Open(att.Type, list);
            }
